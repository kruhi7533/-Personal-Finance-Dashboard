    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--surface-base)] p-4">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-10">
          ...
          <p className="text-sm text-slate-500 font-medium">Create your finance dashboard account</p>
        </div>
        ...
        <div className="bg-[var(--surface-card)] rounded-[32px] border border-[var(--surface-border)]/20 overflow-hidden shadow-[0_32px_100px_-20px_rgba(0,0,0,0.5)]">
          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-6">
            <div className="space-y-2">
              <label className="text-[10px] uppercase tracking-widest font-black text-slate-600 block pl-1">Full Name</label>
              <input
                required
                type="text"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#a3e635] hover:bg-[#bef264] text-[#0a0f1e] py-4 rounded-2xl text-sm font-black uppercase tracking-[0.15em] transition-all active:scale-[0.98] shadow-[0_8px_30px_rgba(163,230,53,0.3)] disabled:opacity-50"
            >
              {loading ? (
          ...
          <div className="px-8 pb-8">
            <p className="text-center text-xs text-slate-500">
              ...
              <Link href="/login" className="text-[#a3e635] font-bold hover:underline">
                Sign in
              </Link>
            </p>
          </div>
